...
export default function CompanyDocumentListPage() {
    ...
    const [sortConfig, setSortConfig] = useState<{ field: keyof CompanyDocument; direction: 'asc' | 'desc' } | null>(null);
    ...
    const handleSort = (field: keyof CompanyDocument) => {
    ...
    const confirmDelete = async () => {
        if (deleteModal.docId) {
            await dispatch(deleteCompanyDocument(deleteModal.docId));
