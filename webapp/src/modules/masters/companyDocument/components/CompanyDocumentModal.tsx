...
interface CompanyDocumentModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (data: Partial<CompanyDocument>) => void;
    editData?: CompanyDocument | null;
}

export default function CompanyDocumentModal({ isOpen, onClose, onSave, editData }: CompanyDocumentModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onSave({
            id: editData?.id,
            title: title.trim(),
            documentFormat: '.docx' // Always .docx for company documents
        });
