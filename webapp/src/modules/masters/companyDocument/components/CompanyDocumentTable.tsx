...
interface CompanyDocumentTableProps {
    ...
    isLoading: boolean;
    sortConfig: { field: keyof CompanyDocument; direction: 'asc' | 'desc' } | null;
    onSort: (field: keyof CompanyDocument) => void;
    onDelete: (id: number, title: string) => void;
    onEdit: (id: number) => void;
}

export const CompanyDocumentTable: React.FC<CompanyDocumentTableProps> = ({
    items,
    isLoading,
    onDelete,
    onEdit
                        ...
                        >
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center justify-center gap-2">
                                    {hasPermission('edit_company_documents') && (
                                        <button
                                    ...
                                    {hasPermission('delete_company_documents') && (
                                        <button
